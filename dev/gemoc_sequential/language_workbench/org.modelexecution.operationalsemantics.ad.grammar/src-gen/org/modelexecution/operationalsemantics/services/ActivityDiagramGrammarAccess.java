...
public class ActivityDiagramGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ActivityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.Activity");
		...
		//'activity'
		//name=EString ('(' inputs+=Variable ("," inputs+=Variable)* ')')?
		//'{' (locals+=Variable ("," locals+=Variable)*)? ('nodes' '{' nodes+=ActivityNode ("," nodes+=ActivityNode)* '}')? ('edges'
	...
	public class ActivityNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.ActivityNode");
	...
	public class ActivityEdgeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.ActivityEdge");
	...
	public class VariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.Variable");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.Expression");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class ValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.Value");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.EString");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OpaqueActionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.OpaqueAction");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	{OpaqueAction}
		//	'action'
		//	name=EString ('comp' '{' expressions+=Expression ("," expressions+=Expression)* '}')? ('in' '('
		...
		//{OpaqueAction}
		//'action'
		//name=EString ('comp' '{' expressions+=Expression ("," expressions+=Expression)* '}')? ('in' '(' incoming+=[ActivityEdge]
		//("," incoming+=[ActivityEdge])* ')')? ('out' '(' outgoing+=[ActivityEdge] ("," outgoing+=[ActivityEdge])* ')')?
		public Group getGroup() { return cGroup; }
	...
	public class InitialNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.InitialNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	{InitialNode}
		//	'initial'
		//	name=EString ('out' '(' outgoing+=[ActivityEdge] ("," outgoing+=[ActivityEdge])* ')');
		@Override public ParserRule getRule() { return rule; }
	...
	public class ActivityFinalNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.ActivityFinalNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	{ActivityFinalNode}
		//	'final'
		//	name=EString ('in' '(' incoming+=[ActivityEdge] ("," incoming+=[ActivityEdge])* ')');
		@Override public ParserRule getRule() { return rule; }
	...
	public class ForkNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.ForkNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//{ForkNode}
		//'fork'
		//name=EString ('in' '(' incoming+=[ActivityEdge] ')') ('out' '(' outgoing+=[ActivityEdge] ("," outgoing+=[ActivityEdge])*
		//')')?
		public Group getGroup() { return cGroup; }
	...
	public class JoinNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.JoinNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//{JoinNode}
		//'join'
		//name=EString ('in' '(' incoming+=[ActivityEdge] ("," incoming+=[ActivityEdge])* ')')? ('out' '(' outgoing+=[ActivityEdge]
		//')')
		public Group getGroup() { return cGroup; }
	...
	public class MergeNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.MergeNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DecisionNodeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.DecisionNode");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerCalculationExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerCalculationExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//	operand1=[IntegerVariable] operator=IntegerCalculationOperator
	...
	public class IntegerComparisonExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerComparisonExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		...
		//	operand1=[IntegerVariable] operator=IntegerComparisonOperator
		//	operand2=[IntegerVariable];
		@Override public ParserRule getRule() { return rule; }
	...
	public class BooleanUnaryExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanUnaryExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cAssigneeBooleanVariableCrossReference_0_0 = (CrossReference)cAssigneeAssignment_0.eContents().get(0);
		private final RuleCall cAssigneeBooleanVariableIDTerminalRuleCall_0_0_1 = (RuleCall)cAssigneeBooleanVariableCrossReference_0_0.eContents().get(1);
	...
	public class BooleanBinaryExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanBinaryExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cAssigneeAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cAssigneeBooleanVariableCrossReference_0_0 = (CrossReference)cAssigneeAssignment_0.eContents().get(0);
		private final RuleCall cAssigneeBooleanVariableIDTerminalRuleCall_0_0_1 = (RuleCall)cAssigneeBooleanVariableCrossReference_0_0.eContents().get(1);
	...
	public class IntegerVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanVariableElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanVariable");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class BooleanValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanValue");
	...
	public class IntegerValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerValue");
		private final Assignment cValueAssignment = (Assignment)rule.eContents().get(1);
	...
	public class EBooleanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.EBoolean");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class EIntElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.EInt");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ControlFlowElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.ControlFlow");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class IntegerCalculationOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerCalculationOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class IntegerComparisonOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.IntegerComparisonOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BooleanUnaryOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanUnaryOperator");
	...
	public class BooleanBinaryOperatorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.modelexecution.operationalsemantics.ActivityDiagram.BooleanBinaryOperator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
