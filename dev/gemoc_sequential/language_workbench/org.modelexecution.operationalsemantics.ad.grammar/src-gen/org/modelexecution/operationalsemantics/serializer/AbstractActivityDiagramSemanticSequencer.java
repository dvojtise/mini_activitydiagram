...
public abstract class AbstractActivityDiagramSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_BooleanBinaryExpression(ISerializationContext context, BooleanBinaryExpression semanticObject) {
		...
		feeder.accept(grammarAccess.getBooleanBinaryExpressionAccess().getAssigneeBooleanVariableIDTerminalRuleCall_0_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.BOOLEAN_EXPRESSION__ASSIGNEE, false));
		feeder.accept(grammarAccess.getBooleanBinaryExpressionAccess().getOperand1BooleanVariableIDTerminalRuleCall_2_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND1, false));
		...
		feeder.accept(grammarAccess.getBooleanBinaryExpressionAccess().getOperand2BooleanVariableIDTerminalRuleCall_4_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.BOOLEAN_BINARY_EXPRESSION__OPERAND2, false));
		feeder.finish();
	}
	...
	protected void sequence_BooleanUnaryExpression(ISerializationContext context, BooleanUnaryExpression semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getBooleanUnaryExpressionAccess().getAssigneeBooleanVariableIDTerminalRuleCall_0_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.BOOLEAN_EXPRESSION__ASSIGNEE, false));
		...
		feeder.accept(grammarAccess.getBooleanUnaryExpressionAccess().getOperandBooleanVariableIDTerminalRuleCall_3_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.BOOLEAN_UNARY_EXPRESSION__OPERAND, false));
		feeder.finish();
	}
	...
	protected void sequence_IntegerCalculationExpression(ISerializationContext context, IntegerCalculationExpression semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getIntegerCalculationExpressionAccess().getAssigneeIntegerVariableIDTerminalRuleCall_0_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_CALCULATION_EXPRESSION__ASSIGNEE, false));
		feeder.accept(grammarAccess.getIntegerCalculationExpressionAccess().getOperand1IntegerVariableIDTerminalRuleCall_2_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_EXPRESSION__OPERAND1, false));
		...
		feeder.accept(grammarAccess.getIntegerCalculationExpressionAccess().getOperand2IntegerVariableIDTerminalRuleCall_4_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_EXPRESSION__OPERAND2, false));
		feeder.finish();
	}
	...
	protected void sequence_IntegerComparisonExpression(ISerializationContext context, IntegerComparisonExpression semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getIntegerComparisonExpressionAccess().getAssigneeBooleanVariableIDTerminalRuleCall_0_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_COMPARISON_EXPRESSION__ASSIGNEE, false));
		feeder.accept(grammarAccess.getIntegerComparisonExpressionAccess().getOperand1IntegerVariableIDTerminalRuleCall_2_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_EXPRESSION__OPERAND1, false));
		...
		feeder.accept(grammarAccess.getIntegerComparisonExpressionAccess().getOperand2IntegerVariableIDTerminalRuleCall_4_0_1(), semanticObject.eGet(ActivitydiagramPackage.Literals.INTEGER_EXPRESSION__OPERAND2, false));
		feeder.finish();
	}
